...
class CustomEmployerAdmin(admin.ModelAdmin):
    list_display = ("id","user", "company_name","phone_number")
    searching_fields = ("user","first_name","phone_number")

admin.site.register(CandidateProfile,CustomProfileAdmin)
admin.site.register(EmployerProfile,CustomEmployerAdmin)
